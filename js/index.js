...
N/B: TO EASILY NAVIGATE BETWEEN COMMENTS AND CODE, THIS CAN BE EASILY DONE USING THE FIND 
     FEATURE (USUALLY CTRL + F) IN ANY REGULAR CODE EDITOR. 
     
     ALTHOUGH CODES ARE PARSED FROM TOP TO BOTTOM, THE PARSING IS NOT STRAIGHTFORWARD SOMETIMES,
     AND THE LOGIC TOO DOES NOT ALWAYS CASCADE. ON THAT NOTE MOST OF THE LOGIC HAVE BEEN GROUPED  
     IN COMMENTS AT THE TOP.
     
     FOR EASY REFERENCE, WHILE SCROLLING THROUGH THE CODE, THE REVIEWER CAN FIND THE REFERENCE OF 
     EVERY LOGIC STEP BY ITS LABEL. 
     
     FOR INSTANCE TO FIND THE REFERENCED CODE WITH THE LOGIC "LISTEN FOR CLICK ON ACCORDION-HEADER
     AND SLIDE CORRESPONDING TEXT DOWN / UP", THE REVIEWER SHOULD SIMPLY FIND "1a." TO EASILY JUMP
     THROUGH THE COMMENT AND THAT PARTICULAR CODE SECTION. (ENSURE TO ADD THE DOT IN "1a." TO MAKE 
     THE FINDING PROCESS UNIQUE AND UNFAILING )
     
     THE FEW EXISTING COMMENTS DOWN IN THE CODE SECTION ARE TO ADD FURTHER CLARIFICATION AS CODER
     DEEMED FIT.
